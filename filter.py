...
data_balai = pd.read_csv('banjarnegara.csv', sep=',')
data_dramaga = pd.read_csv('semarang.csv', sep=',')
...
menit = '00'
data_balai = data_balai[(data_balai.loc[:,'jam'].str[0:8]=='12:'+menit+' AM')]
data_dramaga = data_dramaga[(data_dramaga.loc[:,'jam'].str[0:8]=='12:'+menit+' AM')]
data_tang = data_tang[(data_tang.loc[:,'jam'].str[0:8]=='12:'+menit+' AM')]
...
plt.ylim(-9,-3)
plt.xlim(103,120)
plt.title('20190101  12:'+menit+' AM')
plt.legend(loc=2)
plt.show()
